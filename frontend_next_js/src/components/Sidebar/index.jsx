...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        {/* Sidebar Header */}
        <div className="flex items-center justify-between gap-2 px-6 py-2 pt-5 lg:py-2 lg:pt-5">
          <Link href="/">
            <Image
              width={200}
              height={200}
              src="/images/logo/logo.png"
              className="mx-auto pl-3 mb-0"
              alt="Logo"
              priority
            />
          </Link>
              ...
              <div key={groupIndex}>
                ...
                <ul className="mb-6 flex flex-col gap-1.5">
                  {group.menuItems.map((menuItem, menuIndex) => (
                    user.permissions.includes(menuItem.permission) && (
                      <SidebarItem
                        key={menuIndex}
                        item={menuItem}
                        pageName={pageName}
