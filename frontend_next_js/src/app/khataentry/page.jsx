      ...
      <DefaultLayout>
        ...
        <div>
          ...
          <select
            ...
            name="shopID"
            id="shopID"
            className="text-xl bg-transparent inline-flex items-center justify-center rounded-md border border-primary px-10 py-4 text-center font-medium text-primary lg:px-8 xl:px-10 w-full">
