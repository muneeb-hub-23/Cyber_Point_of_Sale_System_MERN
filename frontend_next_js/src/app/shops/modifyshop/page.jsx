...
const Page = () => {
    ...
    if(user && user.permissions.includes("modifyshop")){
    return (
        <Menu>
        <DefaultLayout>
            <ToastContainer />
            <div className="mx-auto max-w-270">
                <Breadcrumb pageName="Modify Shop" />
            ...
            <div className="rounded-sm border border-stroke w-full text-center items-center bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <table className="w-full">
                    ...
                    <tbody className="my-3">
                        ...
                        <td className="p-3 w-1/5"><Link className="bg-blue-500 cursor-pointer text-white p-3 w-1/5 px-6 text-lg rounded-md shadow-md my-2" href={'/shops/modifyshop/modifyshopform/'+shop._id}>Modify</Link></td>
                    </tr>
                        ))}
